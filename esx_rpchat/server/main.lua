...
RegisterCommand('msg', function(source, args, user)
	...
	if GetPlayerName(tonumber(args[1])) then
		...
		TriggerClientEvent('chat:addMessage', player, {args = {"^5[MSG] ^2"..GetPlayerName(source).. " [" .. source .. "] : ^7" ..table.concat(args, " ")}, color = {255, 255, 255}})
		TriggerClientEvent('chat:addMessage', source, {args = {"^1[MSG] ^2 a  ^2"..GetPlayerName(player).. "^6 [" .. player .. "] ^3[mensaje]: ^0" ..table.concat(args, " ")}, color = {255, 153, 0}})
...
RegisterCommand('oop', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("sendProximityMessageOop", -1, source, table.concat(args, " "))
end)
...
RegisterCommand('pol', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessagePol", -1, source, table.concat(args, " "))
end)

RegisterCommand('sheriff', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageShe", -1, source, table.concat(args, " "))
end)

RegisterCommand('ems', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageEms", -1, source, table.concat(args, " "))
end)

RegisterCommand('ayuda', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageAyuda", -1, source, table.concat(args, " "))
end)

RegisterCommand('twt', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageTwt", -1, source, table.concat(args, " "))
end)

RegisterCommand('anon', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageAnon", -1, source, table.concat(args, " "))
end)

RegisterCommand('dark', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageDark", -1, source, table.concat(args, " "))
end)

RegisterCommand('segunda', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageSeg", -1, source, table.concat(args, " "))
end)

RegisterCommand('meca', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageMec", -1, source, table.concat(args, " "))
end)

RegisterCommand('insta', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageIg", -1, source, table.concat(args, " "))
end)

RegisterCommand('tinder', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageTinder", -1, source, table.concat(args, " "))
end)

RegisterCommand('puti', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessagePuti", -1, source, table.concat(args, " "))
end)

RegisterCommand('baha', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageBah", -1, source, table.concat(args, " "))
end)

RegisterCommand('badu', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageBadu", -1, source, table.concat(args, " "))
end)

RegisterCommand('lico', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageLico", -1, source, table.concat(args, " "))
end)

RegisterCommand('taxi', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageTaxi", -1, source, table.concat(args, " "))
end)

RegisterCommand('cock', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageCock", -1, source, table.concat(args, " "))
end)

RegisterCommand('amu', function(source, args, user)
	local name = GetPlayerName(source)
	TriggerClientEvent("chatMessageAmu", -1, source, table.concat(args, " "))
end)
